import VeritasElement from "/web_components/veritas-element.js";

export class CustomElement extends VeritasElement {
    async connectedCallback() {
        await super.connectedCallback();
        this.canvas = this.shadow_root.getElementById("canvas");
        this.canvas.setAttribute("width", this.getAttribute("size"));
        this.canvas.setAttribute("height", this.getAttribute("size"));
    ...
    draw() {
        ...
        if (this.hasAttribute("timezone")) {
            let timezone = this.getAttribute("timezone");
